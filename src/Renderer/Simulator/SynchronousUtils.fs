...
let couldBeSynchronousComponent compType : bool =
    ...
    | Input _ | Output _ | IOLabel | Constant1 _ | Resistor _ | CurrentSource _ | VoltageSource | Viewer _ -> false
...
let rec hasSynchronousComponents graph : bool =
    ...
    |> Map.map (fun compId comp ->
            ...
            | Input _ | Output _ | IOLabel | Resistor _ | CurrentSource _ | VoltageSource | Constant1 _ | Viewer _ -> false
