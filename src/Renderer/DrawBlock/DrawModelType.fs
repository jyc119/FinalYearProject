...
module SymbolT =
    ...
    type PortId = //| InputId of InputPortId 
    ...
    type Model = {
        ...
        ArePortsConnected:  Set<OutputPortId>

        /// Represents the number of wires connected to each output port in the model
        NumberPortsConnected: Map<OutputPortId, int>
...
module SheetT =
    ...
    type MouseOn =
        ...
        | InputPort of CommonTypes.OutputPortId * XYPos
